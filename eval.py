...
"""
Code to evaluate a trained agent model (game score)
"""

# Example code

# python eval.py --game game_name --architecture aqt --evaluation-episodes 100 --load-model results/***_aqt/models/best_model.pth --cuda-device 0 
...
avg_reward, max_reward, min_reward, std_reward = eval_model(args, dqn)  # Test
print("#"*30)
print("Results")
